        ...
        <div className="mt-0 flex flex-col gap-0.5">
          ...
          >
            <span className="flex min-w-0 items-center gap-3 transition-transform duration-100 group-active:scale-[0.98]">
              <Image
                src="/images/workspace/new-chat.svg"
                alt=""
                width={18}
                height={18}
                className="block shrink-0"
          ...
          <button aria-label="Чати" className={navButtonClasses} title="Чати">
            <Image
              src="/images/workspace/chats-icon.svg"
              alt=""
              width={18}
              height={18}
              className="block shrink-0"
          ...
          <button aria-label="Проєкти" className={navButtonClasses} title="Проєкти">
            <Image
              src="/images/workspace/projects.svg"
              alt=""
              width={18}
              height={18}
              className="block shrink-0"
              ...
              <div className="flex flex-col gap-1">
                ...
                >
                  <div className="flex h-5 w-5 shrink-0 items-center justify-center">
                    <Image
                      src="/images/workspace/settings.svg"
                      alt=""
                      width={20}
                      height={20}
                      aria-hidden
                ...
                >
                  <div className="flex h-5 w-5 shrink-0 items-center justify-center">
                    <Image
                      src="/images/workspace/error.svg"
                      alt=""
                      width={20}
                      height={20}
                      aria-hidden
