...
interface ChatSendIconProps extends SVGProps<SVGSVGElement> {
  canSend?: boolean;
}

export function ChatSendIcon({ canSend, ...props }: ChatSendIconProps) {
  return (
    <svg viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <rect
        ...
        height="36.26"
        rx="8.63"
        fill={canSend ? 'currentColor' : '#EDEDED'}
      />
      {canSend && (
        <rect
          x="0.37"
